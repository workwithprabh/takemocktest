...
35 exams are currently live with real mock tests. See `TAKEMOCKTEST_CURRENT_STATUS.md` for the authoritative current count and `public/llms.txt` for a per-exam summary.
