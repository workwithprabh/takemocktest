    ...
    stages: [
      {
        ...
        tests: [
          ...
          { id: 'engineering-full-mock-2', name: 'WBJEE 2026 Engineering Full Mock Test 2', kind: 'full-length', status: 'checked', duration: 240, timingGroups: [{ sections: ['Mathematics'], duration: 120 }, { sections: ['Physics', 'Chemistry'], duration: 120 }], marksPerCorrect: 1, negativeMarking: 0.25, scoringNote: 'Category 1 questions award 1 mark (-0.25 wrong), Category 2 award 2 marks (-0.5 wrong), and Category 3 multi-select questions award up to 2 marks with no negative marking and proportional partial credit. Paper I (Mathematics) gets 120 minutes and auto-submits; Paper II (Physics and Chemistry) then gets a separate 120 minutes with no return to Paper I.', checkedOn: '24 August 2026' },
        ],
      },
    ],
  },
    ...
    stages: [
      {
        ...
        tests: [
          ...
          { id: 'engineering-full-mock-2', name: 'KCET 2026 Engineering Full Mock Test 2', kind: 'full-length', status: 'checked', duration: 240, timingGroups: [{ sections: ['Physics'], duration: 80 }, { sections: ['Chemistry'], duration: 80 }, { sections: ['Mathematics'], duration: 80 }], marksPerCorrect: 1, negativeMarking: 0, scoringNote: 'Each correct answer awards 1 mark. No negative marking. TakeMockTest online practice adaptation of the KCET 2026 OMR subject papers. The official Engineering subjects are conducted in separate 80-minute sessions; this combined mock preserves three separate 80-minute working windows but does not reproduce the real-world idle gaps between sessions.', checkedOn: '24 August 2026' },
