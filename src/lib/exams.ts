    ...
    stages: [
      ...
      },
      {
        ...
        pattern: {
          ...
          duration: 120,
          negativeMarking: 0.25,
          timerNote: 'Composite 120 minutes for all five sections combined, no sectional lock, matching the same no-lock pattern as Prelims.',
    ...
    stages: [
      ...
      },
      {
        ...
        pattern: {
          ...
          duration: 120,
          negativeMarking: 0.25,
          timerNote: 'Composite 120 minutes for all five sections combined, no sectional lock, matching the same no-lock pattern as Prelims. There is no separate descriptive test for this post (unlike the non-RRB IBPS PO exam).',
