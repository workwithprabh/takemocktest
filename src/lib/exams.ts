    ...
    stages: [
      {
        ...
        tests: [
          ...
          { id: 'verbal-numerical-and-reasoning-full-mock-2', name: 'Verbal, Numerical and Reasoning Full Mock Test 2', kind: 'full-length', status: 'checked', duration: 29, marksPerCorrect: 3, negativeMarking: 1, scoringNote: '1 mark deducted per wrong answer, matching the official AFCAT scheme. Raw score out of 72 shown here; the official test is out of 300 across all four sections.', checkedOn: '17 September 2026' },
          { id: 'verbal-ability-sectional-2', name: 'Verbal Ability Sectional Test 2', kind: 'sectional', status: 'checked', section: 'Verbal Ability', duration: 10, marksPerCorrect: 3, negativeMarking: 1, checkedOn: '17 September 2026' },
          { id: 'numerical-ability-sectional-2', name: 'Numerical Ability Sectional Test 2', kind: 'sectional', status: 'checked', section: 'Numerical Ability', duration: 10, marksPerCorrect: 3, negativeMarking: 1, checkedOn: '17 September 2026' },
          { id: 'reasoning-and-military-aptitude-sectional-2', name: 'Reasoning and Military Aptitude Sectional Test 2', kind: 'sectional', status: 'checked', section: 'Reasoning and Military Aptitude', duration: 9, marksPerCorrect: 3, negativeMarking: 1, checkedOn: '17 September 2026' },
        ],
      },
    ],
  },
