    ...
    stages: [
      ...
      },
      {
        ...
        pattern: {
          ...
          sectionBreakdown: [
            { name: 'Reasoning', questions: 40, marks: 50, duration: 30 },
            { name: 'Numerical Ability', questions: 40, marks: 50, duration: 30 },
            { name: 'General Awareness', questions: 40, marks: 40, duration: 15 },
            { name: 'Computer Knowledge', questions: 40, marks: 20, duration: 15 },
            { name: 'English Language', questions: 40, marks: 40, duration: 30 },
          ],
          sourceUrl: IBPS_RRB_XIV_NOTICE,
          checkedOn: '27 August 2026',
    ...
    stages: [
      ...
      },
      {
        ...
        pattern: {
          ...
          sectionBreakdown: [
            { name: 'Reasoning', questions: 40, marks: 50, duration: 30 },
            { name: 'Quantitative Aptitude', questions: 40, marks: 50, duration: 30 },
            { name: 'General Awareness', questions: 40, marks: 40, duration: 15 },
            { name: 'Computer Knowledge', questions: 40, marks: 20, duration: 15 },
            { name: 'English Language', questions: 40, marks: 40, duration: 30 },
          ],
      ...
      },
      {
        ...
        pattern: {
          ...
          sectionBreakdown: [
            ...
            { name: 'Physics and Chemistry', questions: 15, marks: 15, duration: 120 },
            { name: 'Basics of Computers and Applications', questions: 10, marks: 10, duration: 120 },
            { name: 'Basics of Environment and Pollution Control', questions: 10, marks: 10, duration: 120 },
          ],
    ...
    stages: [
      ...
      },
      {
        ...
        pattern: {
          ...
          sectionBreakdown: [
            { name: 'English Language and Comprehension', questions: 200, marks: 200, duration: 120 },
          ],
    ...
    stages: [
      ...
      },
      {
        ...
        pattern: {
          ...
          sectionBreakdown: [
            { name: 'Commerce', questions: 16, marks: 16, duration: 90 },
            { name: 'Accountancy', questions: 14, marks: 14, duration: 90 },
            { name: 'Management', questions: 14, marks: 14, duration: 90 },
            { name: 'Finance', questions: 16, marks: 16, duration: 90 },
            { name: 'Costing', questions: 14, marks: 14, duration: 90 },
            { name: 'Companies Act', questions: 12, marks: 12, duration: 90 },
            { name: 'Economics', questions: 14, marks: 14, duration: 90 },
          ],
