    ...
    stages: [
      {
        ...
        tests: [
          ...
          { id: 'mathematics-full-mock-2', name: 'Mathematics Full Mock Test 2', kind: 'full-length', status: 'checked', duration: 23, marksPerCorrect: 2.5, negativeMarking: 0.83, scoringNote: 'One-third (0.83) of the 2.5 marks deducted per wrong answer, matching the official Mathematics paper scheme. Raw score out of 45 shown here; the official paper is out of 300.', checkedOn: '18 September 2026' },
          { id: 'algebra-and-trigonometry-sectional-2', name: 'Algebra and Trigonometry Sectional Test 2', kind: 'sectional', status: 'checked', section: 'Algebra and Trigonometry', duration: 8, marksPerCorrect: 2.5, negativeMarking: 0.83, checkedOn: '18 September 2026' },
          { id: 'calculus-and-vectors-sectional-2', name: 'Calculus and Vectors Sectional Test 2', kind: 'sectional', status: 'checked', section: 'Calculus and Vectors', duration: 8, marksPerCorrect: 2.5, negativeMarking: 0.83, checkedOn: '18 September 2026' },
          { id: 'geometry-statistics-and-probability-sectional-2', name: 'Geometry, Statistics and Probability Sectional Test 2', kind: 'sectional', status: 'checked', section: 'Geometry, Statistics and Probability', duration: 7, marksPerCorrect: 2.5, negativeMarking: 0.83, checkedOn: '18 September 2026' },
        ],
      },
      {
        ...
        tests: [
          ...
          { id: 'general-ability-test-english-full-mock-2', name: 'General Ability Test: English Full Mock Test 2', kind: 'full-length', status: 'checked', duration: 12, marksPerCorrect: 4, negativeMarking: 1.33, scoringNote: 'One-third (1.33) of the 4 marks deducted per wrong answer, matching the official GAT scheme. Raw score out of 48 shown here; the official English portion is out of 200 (within a 600-mark GAT paper that also covers General Knowledge, not included here).', checkedOn: '18 September 2026' },
          { id: 'grammar-and-usage-sectional-2', name: 'Grammar and Usage Sectional Test 2', kind: 'sectional', status: 'checked', section: 'Grammar and Usage', duration: 6, marksPerCorrect: 4, negativeMarking: 1.33, checkedOn: '18 September 2026' },
          { id: 'vocabulary-and-comprehension-sectional-2', name: 'Vocabulary and Comprehension Sectional Test 2', kind: 'sectional', status: 'checked', section: 'Vocabulary and Comprehension', duration: 6, marksPerCorrect: 4, negativeMarking: 1.33, checkedOn: '18 September 2026' },
        ],
      },
    ],
  },
    ...
    stages: [
      {
        ...
        tests: [
          ...
          { id: 'elementary-mathematics-full-mock-2', name: 'Elementary Mathematics Full Mock Test 2', kind: 'full-length', status: 'checked', duration: 22, marksPerCorrect: 1, negativeMarking: 0.33, scoringNote: 'One-third (0.33) of a mark deducted per wrong answer, matching the official Elementary Mathematics scheme. Raw score out of 18 shown here; the official paper is out of 100.', checkedOn: '18 September 2026' },
          { id: 'arithmetic-sectional-2', name: 'Arithmetic Sectional Test 2', kind: 'sectional', status: 'checked', section: 'Arithmetic', duration: 7, marksPerCorrect: 1, negativeMarking: 0.33, checkedOn: '18 September 2026' },
          { id: 'algebra-and-trigonometry-sectional-2', name: 'Algebra and Trigonometry Sectional Test 2', kind: 'sectional', status: 'checked', section: 'Algebra and Trigonometry', duration: 7, marksPerCorrect: 1, negativeMarking: 0.33, checkedOn: '18 September 2026' },
          { id: 'geometry-and-mensuration-sectional-2', name: 'Geometry and Mensuration Sectional Test 2', kind: 'sectional', status: 'checked', section: 'Geometry and Mensuration', duration: 8, marksPerCorrect: 1, negativeMarking: 0.33, checkedOn: '18 September 2026' },
        ],
      },
      {
        id: 'english',
        ...
        tests: [
          ...
          { id: 'english-full-mock-2', name: 'English Full Mock Test 2', kind: 'full-length', status: 'checked', duration: 12, marksPerCorrect: 1, negativeMarking: 0.33, scoringNote: 'One-third (0.33) of a mark deducted per wrong answer, matching the official negative-marking ratio. Raw score out of 12 shown here; the official paper is out of 100 across 120 questions.', checkedOn: '18 September 2026' },
          { id: 'grammar-and-usage-sectional-2', name: 'Grammar and Usage Sectional Test 2', kind: 'sectional', status: 'checked', section: 'Grammar and Usage', duration: 6, marksPerCorrect: 1, negativeMarking: 0.33, checkedOn: '18 September 2026' },
          { id: 'vocabulary-and-comprehension-sectional-2', name: 'Vocabulary and Comprehension Sectional Test 2', kind: 'sectional', status: 'checked', section: 'Vocabulary and Comprehension', duration: 6, marksPerCorrect: 1, negativeMarking: 0.33, checkedOn: '18 September 2026' },
        ],
      },
    ],
  },
