    ...
    stages: [
      {
        ...
        pattern: {
          status: 'review-pending',
          cycle: '2026',
          sections: ['Use of English', 'Mathematics', 'Physics', 'Chemistry', 'Government', 'Economics'],
          totalQuestions: 180,
          totalMarks: 400,
          duration: 120,
          negativeMarking: 0,
          ...
          note: 'Every candidate sits Use of English plus three subjects chosen to match the course applied for, so there is no single national subject list. The six subjects listed above are the ones this site covers, offered as two combinations: science (Use of English, Mathematics, Physics, Chemistry) and commercial (Use of English, Mathematics, Economics, Government). Any one candidate sits four of them. The overall shape of the paper (180 questions, 60 in Use of English and 40 in each of the other three, two hours, 400 marks scaled across the four subjects at 100 each, and no penalty for a wrong answer) is consistently reported across multiple independent current sources. The official JAMB brochure could not be independently read in this environment: jamb.gov.ng is unreachable from the network this site is built on. Status is marked review-pending for that reason, and stays there until the primary source is read. Literature-in-English is not built, because most of that paper is set on prescribed texts that rotate by cycle and writing questions on them would mean asserting the content of books that could not be verified here. Questions on the JAMB-recommended novel are excluded from the Use of English paper for the same reason. Within Government and Economics, current officeholders, current statistics and recent policy are excluded, and the questions are confined to settled constitutional, institutional, historical and analytical content.',
        },
        tests: [
