    ...
    stages: [
      {
        ...
        pattern: {
          ...
          sectionBreakdown: [
            { name: 'Verbal Ability', questions: 25, marks: 25 },
            { name: 'Reading Comprehension', questions: 15, marks: 15 },
            { name: 'Quantitative Aptitude', questions: 15, marks: 15 },
            { name: 'Data Adequacy and Data Interpretation', questions: 15, marks: 15 },
          ],
    ...
    stages: [
      {
        ...
        pattern: {
          ...
          sectionBreakdown: [
            { name: 'Language Comprehension', questions: 10, marks: 10 },
            { name: 'Intelligence and Critical Reasoning', questions: 10, marks: 10 },
            { name: 'Mathematical Skills', questions: 10, marks: 10 },
            { name: 'Data Analysis and Sufficiency', questions: 10, marks: 10 },
          ],
