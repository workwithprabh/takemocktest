    ...
    stages: [
      {
        ...
        pattern: {
          ...
          sectionBreakdown: [
            { name: 'General English', questions: 15, marks: 15 },
            { name: 'Analytical and Logical Reasoning', questions: 25, marks: 25 },
