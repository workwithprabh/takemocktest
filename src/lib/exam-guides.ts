        ...
        },
        {
          ...
          sections: [
            ...
            },
            {
              ...
              pattern: '40 questions',
              topics: [
                'Basic concepts: power, authority, legitimacy and sovereignty',
                'The state, its attributes and forms of government',
                'Unitary, federal and confederal systems',
                'Presidential and parliamentary systems',
                'Organs of government, separation of powers and checks and balances',
                'Constitutions, constitutionalism, the rule of law and fundamental rights',
                'Political parties, party systems, elections and pressure groups',
                'The civil service and public corporations',
                'Pre-colonial Hausa and Fulani, Yoruba and Igbo political systems',
                'Colonial rule, indirect rule and Nigerian constitutional development',
                'Independence, the republics and the 1999 Constitution',
                'Nigeria in ECOWAS, the African Union, the United Nations and OPEC',
              ],
            },
            {
              section: 'Economics',
              pattern: '40 questions',
              topics: [
                'Scarcity, choice, opportunity cost and the scale of preference',
                'Economic systems and the price mechanism',
                'Statistical tools: measures of central tendency and dispersion',
                'Demand, supply, market equilibrium and price control',
                'Elasticity of demand and supply',
                'Consumer behaviour and the law of diminishing marginal utility',
                'Factors of production, production functions and economies of scale',
                'Costs, revenue and the behaviour of the firm',
                'Market structures: perfect competition, monopoly, oligopoly and monopolistic competition',
                'Distribution theory: rent, wages, interest and profit',
                'National income: concepts, measurement and its problems',
                'Money, inflation, financial institutions and the capital market',
                'Public finance: taxation, budgets and fiscal policy',
