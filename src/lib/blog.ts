...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    body: [
      ...
      { type: 'paragraph', heading: 'Where the stages are not what they look like', text: `Counting stages is less obvious than it sounds, and this site counts only stages whose pattern has been checked against an official notice. Some exams publish papers that look like stages and are not: JEE Advanced sets Paper 1 and Paper 2 on the same day and both are compulsory, which is two papers rather than a funnel, and NDA's two papers work the same way. Others have stages this site has not confirmed yet and so does not count. Before you plan around a number, read the selection process on the exam's own page rather than a summary anywhere, including this one.` },
