...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    title: 'RRB JE CBT 2: Civil vs Mechanical — What the Technical Abilities Section Actually Tests',
    excerpt: 'CBT 2 for RRB Junior Engineer is the same 150-question shell for every branch, but Technical Abilities (100 of those 150 marks) is a completely different paper depending on whether you picked Civil or Mechanical.',
    category: 'Exam Guides',
    readTimeMin: 6,
    publishedAt: '2026-08-28',
    authorName: 'TakeMockTest Editorial',
    body: [
      { type: 'paragraph', text: 'RRB Junior Engineer recruitment runs two Computer Based Tests: a common CBT 1 that every JE, DMS, and CMA candidate sits regardless of branch, followed by CBT 2, where the paper stops being common. CBT 2 keeps the same overall shell across branches, 150 questions, 150 marks, 120 minutes, one composite timer, but two-thirds of it (the Technical Abilities section) is written entirely around whichever engineering discipline you applied for. A Civil candidate and a Mechanical candidate sit what is functionally a different exam under an identical cover page.' },
      { type: 'takeaways', items: [
        'CBT 2 is 150 questions for 150 marks in 120 minutes, one composite timer, no sectional lock, 0.333 marks deducted per wrong answer, same as CBT 1.',
        'Technical Abilities is 100 of the 150 questions and is entirely branch-specific; the other 50 (General Awareness, Physics and Chemistry, Basics of Computers and Applications, Basics of Environment and Pollution Control) are common to every discipline.',
        'Civil Engineering\'s Technical Abilities leans structural and site-work: Building Materials and Structural Analysis alone account for 46 of its 100 practiced questions on this site.',
        'Mechanical Engineering\'s Technical Abilities spreads more evenly across eight topics, from Engineering Mechanics and Strength of Materials through Thermodynamics, IC Engines, and Production Engineering.',
        'General Awareness (15 of the 150 official questions) is current-affairs content and is deliberately not built here; this site\'s CBT 2 mocks cover the other 135 marks.',
      ] },
      { type: 'table', heading: 'CBT 2 section breakdown (same for every branch)', headers: ['Section', 'Questions', 'Marks', 'Branch-specific?'], rows: [
      ...
      { type: 'callout', text: 'Civil\'s Technical Abilities section is top-heavy: Building Materials and Structural Analysis alone make up 46 of its 100 questions. Mechanical\'s is spread far more evenly across eight topics, with no single topic past 16.' },
      { type: 'paragraph', heading: 'What this means for your prep split', text: 'If you are preparing for Civil, Building Materials and Structural Analysis deserve the largest, earliest block of your revision time, since together they are nearly half the Technical Abilities section; Irrigation Engineering and Estimating and Costing are real but smaller stakes. If you are preparing for Mechanical, no single topic dominates the way Building Materials does for Civil, so a more even rotation across Engineering Mechanics, Strength of Materials, Theory of Machines, and Thermodynamics pays off better than concentrating on one or two areas and hoping the rest averages out.' },
