...
export const BLOG_POSTS: BlogPost[] = [
...
},
  {
    ...
    title: 'RRB Paramedical CBT: Why Only 30 of the 100 Questions Are the Same for Everyone',
    excerpt: 'Professional Ability makes up 70 of the 100 questions, and it is a different syllabus for every post. This is a rare case where being honest about coverage matters more than pretending one mock test fits every candidate.',
    category: 'Exam Guides',
    readTimeMin: 6,
    ...
    body: [
      ...
      { type: 'takeaways', items: [
        ...
        'The minimum pass percentage is 40% for UR and EWS, 30% for OBC and SC, and 25% for ST — a bar that applies to your overall score, not just the sections you can meaningfully practice for generically.',
      ] },
  ...
  },
  {
    ...
    title: 'SSC CPO Paper 1 vs Paper 2: Same Marks, Completely Different Shape',
    excerpt: 'Paper 2 is not a smaller, secondary round tacked onto the end. It carries exactly as many marks as all four sections of Paper 1 combined, and it is also the first tie-breaker in the final merit list.',
    category: 'Exam Guides',
    readTimeMin: 6,
    publishedAt: '2026-08-29',
    authorName: 'TakeMockTest Editorial',
  ...
  },
  {
    ...
    title: 'SSC JE Paper I: Why This Site Only Covers a Quarter of the Exam',
    excerpt: 'Paper I is worth 100 marks. Paper II, the discipline-specific General Engineering paper, is worth 300. That 400-mark total is the honest context for what a Paper I mock test can and cannot do for you.',
    category: 'Exam Guides',
    readTimeMin: 5,
    publishedAt: '2026-08-29',
    authorName: 'TakeMockTest Editorial',
    body: [
      ...
      { type: 'takeaways', items: [
        'Paper I and Paper II are not equal weight: Paper I is 100 marks, Paper II is 300, so three-quarters of your total SSC JE score comes from the discipline-specific paper.',
        'Paper I has no sectional lock: General Intelligence and Reasoning and General Awareness, 50 questions each, share one 120-minute composite timer.',
      ...
      { type: 'table', heading: 'Paper I vs Paper II', headers: ['', 'Paper I', 'Paper II'], rows: [
        ['Content', 'General Intelligence and Reasoning, General Awareness', 'General Engineering (discipline-specific)'],
        ['Questions / Marks', '100 / 100', '100 / 300'],
        ['Duration', '120 minutes', 'Set separately by discipline'],
        ['Covered on this site?', 'Yes', 'No — no single common syllabus'],
      ] },
      ...
      { type: 'paragraph', heading: 'What Paper I actually tests', text: 'Paper I is common to every discipline: General Intelligence and Reasoning and General Awareness, 50 questions each, on one continuous 120-minute timer with no sectional lock. Since Paper I and Paper II scores are normalized and combined for the final merit list, a strong Paper I score genuinely matters, it is just worth being clear-eyed that it represents 100 of the 400 total marks, not the exam as a whole.' },
      { type: 'callout', text: 'Paper I is worth 100 of the 400 total SSC JE marks. A strong Paper I score matters, but it is a quarter of the exam, not the whole of it.' },
    ...
    faqs: [
      ...
      { q: 'What is the difference between SSC JE Paper I and Paper II?', a: 'Paper I (100 marks) covers General Intelligence and Reasoning and General Awareness, common to every discipline. Paper II (300 marks) is General Engineering, a discipline-specific technical paper that differs by Civil & Structural, Electrical, or Mechanical stream.' },
      { q: 'Why doesn\'t this site cover SSC JE Paper II?', a: 'Paper II\'s technical syllabus differs by engineering discipline, so a single question bank cannot accurately represent Civil, Electrical, and Mechanical candidates at once. Only Paper I, which is common to every discipline, is modeled.' },
      ...
      { q: 'Does SSC JE Paper I have a sectional lock?', a: 'No. General Intelligence and Reasoning and General Awareness, 50 questions each, share one continuous 120-minute timer.' },
    ],
  },
  {
    slug: 'rpf-constable-vs-rpf-si-same-cbt-different-post',
    title: 'RPF Constable vs RPF SI: The CBT Is Nearly Identical — the Post Isn\'t',
    excerpt: 'Same 120 questions, same three sections, same 90-minute timer, same marking scheme. If you are deciding between the two, the written-test preparation genuinely does not change.',
    category: 'Exam Guides',
    readTimeMin: 5,
    publishedAt: '2026-08-29',
    authorName: 'TakeMockTest Editorial',
