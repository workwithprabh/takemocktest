    ...
    groups: [
      {
        ...
        exams: [
          ...
          exam('SSC CPO', 'National'),
          exam('SSC GD Constable', 'National'),
      ...
      },
      {
        ...
        exams: [
          ...
          exam('IBPS RRB Office Assistant', 'National'),
          exam('SBI PO', 'National', 'sbi-po'),
          exam('SBI Clerk', 'National'),
          exam('RBI Grade B', 'National'),
          exam('RBI Assistant', 'National', 'rbi-assistant'),
          exam('NABARD Grade A', 'National'),
          exam('SEBI Grade A', 'National'),
      ...
      },
      {
        ...
        exams: [
          ...
          exam('RRB Assistant Loco Pilot', 'National'),
          exam('RRB Technician', 'National'),
          exam('RRB Junior Engineer / DMS / CMA', 'National'),
          exam('RRB Paramedical Categories', 'National'),
          exam('RPF Sub-Inspector', 'National'),
          exam('RPF Constable', 'National'),
        ],
      },
      {
