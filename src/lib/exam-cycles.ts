...
const EXAM_CYCLES: Partial<Record<ExamSlug, ExamCycle>> = {
  'upsc-cse': {
    ...
    summary: 'The written Main Examination is scheduled for 21 to 23 and 29 to 30 August 2026.',
    ...
    importantDates: [
      ...
      },
      {
        ...
        displayDate: '19 to 29 June 2026, until 6:00 pm',
        status: 'Closed',
      ...
      },
      {
        ...
        dateTime: '2026-08-21',
        displayDate: '21 to 23 and 29 to 30 August 2026',
        status: 'Upcoming',
