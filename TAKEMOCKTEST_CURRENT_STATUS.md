...
- Live catalog entries with a `liveSlug` (`exam-catalog.ts` × `exams.ts` `ExamSlug` union, both cross-checked and matching): 40
- Question-bank files (`src/lib/question-banks/*.ts`): 219
- Questions: 6,830
