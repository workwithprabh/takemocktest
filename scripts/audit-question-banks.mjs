...
for (const { file, questions } of banks) {
  const expectedCount = file.startsWith('ssc-cgl-tier2-english-')
    ...
    : file.startsWith('snap-general-english-analytical-logical-reasoning-quantitative-di-ds-combined-') ? 60 : 25;
