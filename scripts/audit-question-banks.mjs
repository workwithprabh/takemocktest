...
for (const { file, questions } of banks) {
  const expectedCount = file.startsWith('ssc-cgl-tier2-english-')
    ...
    : file.startsWith('ctet-2026-paper-1-child-development-pedagogy-') ? 30
    : file.startsWith('ctet-2026-paper-1-mathematics-') ? 30
    : file.startsWith('ctet-2026-paper-1-environmental-studies-') ? 30
    : file.startsWith('ctet-2026-paper-1-language-1-english-') ? 30
    : file.startsWith('ctet-2026-paper-1-language-2-hindi-') ? 30
    ...
    : file.startsWith('nchm-jee-2026-gk-current-affairs-') ? 15
    ...
    : file.startsWith('ap-lawcet-2026-5y-gk-mental-ability-') ? 30
